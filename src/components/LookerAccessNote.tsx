...
export default function LookerAccessNote() {
  return (
    <p className="rounded-control border border-my-line bg-my-paper px-4 py-3 text-sm text-my-slate">
      Seeing{" "}
      <em>&quot;Your current account can&apos;t access this report&quot;</em>{" "}
      above? The report hasn&apos;t been shared with your Google account.
      That&apos;s report sharing in Looker Studio, not a hub problem. Ask an
      administrator (crm@meloyelo.nz) to open the report, choose Share, and add
      your email as Viewer. If the report no longer exists, ask them to remove
      this page instead of leaving a broken embed.
    </p>
  );
}
