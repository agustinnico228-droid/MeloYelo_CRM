    ...
    return (
      <main className="mx-auto max-w-2xl p-6">
        ...
        <p className="mt-4 rounded-card border border-my-line bg-my-surface p-6 text-my-slate shadow-card">
          This queue is the Ride Guide&apos;s calling list. Your own leads are
          on Today and Leads.
        </p>
      </main>
    );
  ...
  return (
    <main className="mx-auto max-w-4xl p-4 sm:p-6">
      ...
      <p className="mt-1 text-sm text-my-slate">
        Website leads only, most urgent first: never-contacted at the top, then
        longest since the last stage change. Leads the agent already contacted
        are marked so you can skip them.{" "}
          ...
          {queue.map((lead) => {
            ...
            return (
              ...
              >
                ...
                <Link href={`/leads/${lead.uniqueId}`} className="btn-brand">
                  Open
                </Link>
              </li>
            );
